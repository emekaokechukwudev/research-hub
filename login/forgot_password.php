...
<body data-new-gr-c-s-loaded="9.22.0">
	...
	<div class="login-form">
	    ...
	    <div class="alert alert-danger fade collapse" id="forgot_password_failed">
		    <strong>Email not registered: </strong><a href="register.php" class="alert-link"> click here to register.</a> 
	    </div>
	    ...
	    <form action="" method="post">
	        ...
	        <div class="form-group">
	            <button type="submit" class="btn btn-block" id="forgotbutton" style="background-color: #923D41; color: white;" onclick="forgotpassword()">Submit Request</button>
	        </div>
	               
	    </form>
	    <p class="text-center"><a href="../login/register.php" style="color:#923D41;">Join</a> | <a href="../index.php" style="color:#923D41;">Home</a> | 
