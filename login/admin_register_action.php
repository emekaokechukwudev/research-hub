...
// Call function to register admin user
$admin_register_user = admin_register_user_fxn($userid, $firstname, $lastname, $email, $password);

if (!$admin_register_user) {
    echo 'failed';
}
...
try {
    ...
    $mail->Subject = "Activate Your Admin Account - Research Hub";
    $mail->Body = '
    <p>Dear '.$firstname.',</p>
    <p>You recently created an account on the Research Hub website. If you did not initiate this transaction, kindly ignore, 
    delete and report this activity: <a href="mailto:'.SUPER_ADMIN_EMAIL.'?subject=Research%20Account%20Creation%20Intrusion%20Alert">
    click here to report</a></p>
    <p>Else click the link below to activate your account</p>
    <p><a href="http://'.LOCALHOST_ADDRESS.'/research-hub/actions/admin_activate_email.php?accountemail='.urlencode($encrypted_email).'">Activate account</a></p>
    <p>Regards,</p>
