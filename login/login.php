...
<body>
	...
	<div class="login-form">
		...
		<div class="alert alert-danger fade collapse" id="user_pending">
		    <strong>User Account is Pending:</strong> You registered as a faculty researcher and awaiting verification. 
			Follow up with the "Need Help?" below.
	    </div>
	    ...
	    <form action="" method="post">
	        <h2 class="text-center">Research Hub</h2>       
	        ...
	        <div class="form-group">
	            <button type="submit" class="btn btn-block" name="loginbutton" id="loginbutton" style="background-color: #923D41; color: white;" onclick="loginvalidation()">Log in</button>
	        </div>
	    ...
	    <p class="text-center"><a href="../login/register.php" style="color:#923D41;">Join</a> | 
		<a href="../index.php" style="color:#923D41;">Home</a> | <a href="forgot_password.php" style="color:#923D41;">Forgot Password?</a> | 
		<a href="mailto:<?php echo SUPER_ADMIN_EMAIL; ?>?subject=Research%20Hub%20Enquiry" style="color:#923D41;"> Help?</a> | 
		<a href="admin_login.php" style="color:#923D41;"> Admin?</a></p>
	</div>
