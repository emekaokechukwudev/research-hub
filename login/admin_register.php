...
<html>
<head>
	<title>Research Hub - Admin Register</title>
	...
	<div class="login-form">
	    ...
	    <form action="" method="post">
			...
			<div class="form-group">
	            <input type="text" class="form-control" placeholder="User ID" name="userid" id="userid" maxlength="8" required="required">
	        </div>
	        <div class="form-group">
	        ...
	        <div class="form-group">
				<button type="submit" class="btn btn-block" style="background-color: #923D41; color: white;" name="adminregisterbutton" id="adminregisterbutton" onclick="adminregistervalidation()">Register</button>
	        </div>
	               
	    </form>
	    <p class="text-center"><a href="admin_login.php" style="color:#923D41;">Login</a> | <a href="../index.php" style="color:#923D41;">Home</a> | 
