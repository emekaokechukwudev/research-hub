...
$check_login = admin_login_user_fxn($email);
...
try {
    ...
    $mail->Subject = "Reset Forgotten Admin Password - Research Hub";
    $mail->Body = '
    <p>Dear '.$firstname.',</p>
    <p>You recently requested to change your admin password on the Research Hub website. If you did not initiate this transaction, kindly ignore, 
    ...
    <p>Else click on the link below to reset your admin password. This link expires in 24 hours</p>
    <p><a href="http://'.LOCALHOST_ADDRESS.'/research-hub/view/admin_user_password_reset.php?accountemail='.urlencode($encrypted_email).'">Reset Password</a></p>
    <p>Regards,</p>
