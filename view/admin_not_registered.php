...
<html>
<head>
	<title>Research Hub - Not Registered</title>
...
<body>
	<div class="jumbotron" style="text-align: center; background-color: #923D41; color: white;">
		<h1>Admin Not Registered</h1>
		<p>Your email was not found on our system</p>
		<p><a href="../login/admin_register.php">Click here to register</a></p>
	</div>
</body>
</html>