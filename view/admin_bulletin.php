				...
				<div class="tab-content container"> <br>
					...
					<?php
						...
						if ($event_list) {
								...
								echo "<li class='media'>
									...
									<div class='table-responsive'>
										<div class='media-body pl-3'>
											<h4 class='media-heading'>".$event['event_title']." "."<i class='btn-sm btn-secondary view_detail' onclick='' style='cursor:pointer;' data-toggle='modal' data-target='#viewModal' id='$event_id'>read more...</i>
											<a href='manage_bulletin.php?manage_event=$event_id'><i class='btn-sm btn-info'>Manage Event</i></a></h4>
							...
							echo 'No events here yet...come back later :)';
						}

						echo '<hr> 
						<ul class="pagination pagination-sm">
							<li class="page-item">
								<a class="page-link" href="admin_bulletin.php?page=1">First</a>
							</li>';
			
							if ($page >= 2) {   
								echo '<li class="page-item">
									<a class="page-link" href="admin_bulletin.php?page='.($page - 1).'">Previous</a>
								</li>';   
							}       
							...
							for ($page_number = 1; $page_number <= $number_of_pages; $page_number++) {   
								if ($page_number == $page) {   
									echo '<li class="page-item active">
										<a class="page-link" href="admin_bulletin.php?page='.$page_number.'">'.$page_number.' </a>
									</li>';   
								} else { 
									echo '<li class="page-item">
										<a class="page-link" href="admin_bulletin.php?page='.$page_number.'">'.$page_number.' </a>
							...
							if ($page < $number_of_pages) {   
								echo '<li class="page-item">
									<a class="page-link" href="admin_bulletin.php?page='.($page + 1).'">Next</a>
								</li>';
							}
							
							echo '<li class="page-item">
								<a class="page-link" href="admin_bulletin.php?page='.$number_of_pages.'">Last</a>
							</li>
						</ul>
						<!-- End of pagination -->
						...
						if ($news_list) {
							...
							foreach ($news_list as $news) {
								...
								echo "<div class='card'>
									...
									<div class='card-body'>
										<b>Date Published: ".$news['custom_date']." <a href='manage_bulletin.php?manage_news=$news_id'><i class='btn-sm btn-info'>Manage News</i></a>
										</b></br></br>
							...
							echo 'No news here yet...come back later :)';
						}
					?>
				</div>
			</div>
