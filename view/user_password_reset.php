...
<html>
<head>
	<title>Research Hub - Reset Password</title>
...
<body>
	...
	<div class="login-form">
	    ...
	    <form action="" method="post">
	        ...
	        <div class="form-group">
	            <button type="Submit" class="btn btn-block" name="resetpasswordbutton" id="resetpasswordbutton" style="background-color: #923D41; color: white;" onclick="resetpassword()">Submit</button>
	        </div>
