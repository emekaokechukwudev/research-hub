		...
		<div class="tab-content container">
			...
			<?php	
						...
						echo "<li class='media'>
							...
							<div class='table-responsive'>
								<div class='media-body pl-3'>
									<h4 class='media-heading' style=''>".$grant['grant_name']." "."<i class='btn-sm btn-secondary view_detail' style='cursor:pointer;' data-toggle='modal' data-target='#viewModal' id='$grant_id'>read more...</i>
									<a href='manage_grant_opportunity.php?edit=$grant_id'><i class='btn-sm btn-info'>Manage Grant</i></a></h4>
				...
				<ul class="pagination pagination-sm">
					<li class="page-item">
						<a class="page-link" href="admin_grant_opportunities.php?page=1">First</a>
					</li>';

					if ($page >= 2) {
						echo '<li class="page-item">
							<a class="page-link" href="admin_grant_opportunities.php?page='.($page - 1).'">Previous</a>
						</li>';
					}
					...
					for ($page_number = 1; $page_number <= $number_of_pages; $page_number++) {
						if ($page_number == $page) {
							echo '<li class="page-item active">
								<a class="page-link" href="admin_grant_opportunities.php?page='.$page_number.'">'.$page_number.' </a>
							</li>';
						}
						else {
							echo '<li class="page-item">
					...
					if ($page < $number_of_pages) {
						echo '<li class="page-item">
							<a class="page-link" href="admin_grant_opportunities.php?page='.($page + 1).'">Next</a>
						</li>';   
					}
					
					echo '<li class="page-item">
						<a class="page-link" href="admin_grant_opportunities.php?page='.$number_of_pages.'">Last</a>
					</li>
				</ul>
				<!-- End of pagination -->
