            ...
            <form class="tab-content" action="" role="form" method="post">
                ...
                <div class="row form-group">
                    ...
                    <div class="col">
						...
						<button type="submit" class="btn btn-block btn-info" name="teamupdateresearchbutton" id="teamupdateresearchbutton" onclick="teamupdateresearch()"><span class="fa fa-edit"></span> Update Research</button>
					</div>

					<div class="col">
						
						<!-- Error messages -->
						<div class="alert alert-danger fade collapse" id="leave_research_failed">
							<strong>Failed to leave research!</strong> Kindly try again and contact admin.
						</div>
						
						<button type="submit" class="btn btn-block btn-danger" name="leaveresearchbutton" id="leaveresearchbutton" onclick="leaveresearch()"><span class="fa fa-sign-out-alt"></span> Leave Research</button>
					</div>
				</div>
					...
					<div class="table-responsive">
						<?php
							echo '<table class="table table-hover table-sm">
								...
								$research_leader = view_research_leader_fxn($b);
								...
								echo "<tbody>
									<tr>
										...
										<td class='text-nowrap'>Send Email<a href='mailto:".$research_leader[0]['email_address']."?subject = Invitation to my research & body = '><i class='btn fa fa-envelope'></i></a></td>
									</tr>";
								...
								if ($user_list) {
									...
									echo 'There is currently no member on this research team. Click <b>Add To Team</b> to add users.';
								}
