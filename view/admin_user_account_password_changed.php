...
<html>
<head>
	<title>Research Hub - Admin Password Changed</title>
...
<body>
	<div class="jumbotron" style="text-align: center; background-color: #923D41; color: white;">
		<h1>Admin User Account Password Successfully Changed</h1>
		<p><a href="../login/admin_login.php">Click here to login</a></p>
	</div>
</body>
</html>