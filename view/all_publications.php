...
<html>
<head>
	<title>Research Hub - Research Publications</title>
    ...
    <meta name="author" content="Emeka Okechukwu - Software Developer">
...
<body>
	...
	<div class="container mt-1">
		...
		<h2 style="color: #923D41;"><span class="fa fa-book"></span> All Publications</h2>
		</br>

		<ul class="nav nav-tabs">
			<li class="nav-item">
				<a class="nav-link active" data-toggle="tab">All Published Research</a>
			</li>
	  	</ul>
		...
		<div class="container tab-pane active"><br>
			...
			<!-- List of all published research -->
			<div class="table-responsive">
				<?php
					echo '<table class="table table-hover table-sm">
						...
						$research_list_unpaginated = view_all_published_research_fxn($a);
						...
						$research_list = view_all_published_research_pagination_fxn($a, $this_page_first_result, $results_per_page);
						...
						if (isset($_GET['searchbutton'])) {
							...
							$research_list = search_all_published_research_fxn($term, $a);
						}
						...
						if ($research_list) {
							...
							echo 'No published research found';
						}
						
					echo '</table>';
				
					echo (isset($_GET['searchbutton']))? '<div>
					<a class="far fa-arrow-alt-circle-left fa-3x" href="all_publications.php"></a> </div>' : '';

					echo (isset($_GET['searchbutton']))? '' : '<ul class="pagination pagination-sm">
						<li class="page-item">
							<a class="page-link" href="all_publications.php?page=1">First</a>
						</li>';

						if ($page >= 2) {   
							echo (isset($_GET['searchbutton']))? '' : '<li class="page-item">
								<a class="page-link" href="all_publications.php?page='.($page - 1).'">Previous</a>
							</li>';   
						}       
						...
						for ($page_number = 1; $page_number <= $number_of_pages; $page_number++) {   
							if ($page_number == $page) {   
								echo (isset($_GET['searchbutton']))? '' : '<li class="page-item active">
									<a class="page-link" href="all_publications.php?page='.$page_number.'">'.$page_number.' </a>
								</li>';
							} else {
								echo (isset($_GET['searchbutton']))? '' : '<li class="page-item">
									<a class="page-link" href="all_publications.php?page='.$page_number.'">'.$page_number.' </a>
						...
						if ($page < $number_of_pages) {   
							echo (isset($_GET['searchbutton']))? '' : '<li class="page-item">
								<a class="page-link" href="all_publications.php?page='.($page + 1).'">Next</a>
							</li>';   
						}   
						
						echo (isset($_GET['searchbutton']))? '' : '<li class="page-item">
							<a class="page-link" href="all_publications.php?page='.$number_of_pages.'">Last</a>
						</li>
					</ul>
					<!-- End of pagination -->
					...
					<div>
						<small>
							Total Published Research: '.$number_of_results.'<br>
